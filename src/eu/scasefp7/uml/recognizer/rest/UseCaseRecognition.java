...
@Path("/usecase")
public class UseCaseRecognition {
	@POST
	...
	public Response post(MultiPart multiPart) {
		...
		try {
			...
			recognizer.setParameters(true, false, image.getImageThreshold(), image.getRectangleRate(), image.getMinDistance(), image.getMinRate());
			recognizer.process();
